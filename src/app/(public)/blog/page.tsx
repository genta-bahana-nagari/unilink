...
const POSTS = [
  {
    ...
    excerpt: "How AI and machine learning are transforming the way researchers find participants for their studies.",
  ...
  },
  {
    ...
    excerpt: "Strategies for creating diverse and representative participant pools in academic research.",
  ...
  },
  {
    ...
    excerpt: "Tips for organizing successful academic and professional events with better engagement.",
  ...
  },
  {
    ...
    excerpt: "Understanding what motivates people to participate in research studies and events.",
  ...
  },
  {
    ...
    excerpt: "Navigating the IRB process with better documentation and participant communication.",
  ...
  },
  {
    ...
    excerpt: "Emerging technologies shaping the future of academic and professional events.",
    author: "David Kim",
    date: "2023-12-15",
    readTime: "5 min read",
    category: "Events",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-16 sm:pt-20 lg:pt-28 pb-8 sm:pb-12 lg:pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
            Explore our latest articles on research, events, and community building.
          </p>
                ...
                <div className="p-5 sm:p-6 md:p-8 flex flex-col">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-border mt-auto">
                    <div className="flex items-center gap-3">
                      <Avatar fallback={featuredPost.author.charAt(0)} size="sm" />
                      <div>
      ...
      <section className="px-4 pb-12 sm:pb-16 lg:pb-20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-6 sm:mb-8">Latest Articles</h2>
                ...
                <div className="p-4 sm:p-5 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-border mt-auto">
                    <div className="flex items-center gap-2">
                      <Avatar fallback={post.author.charAt(0)} size="sm" className="w-6 h-6" />
      ...
      <section className="px-4 py-12 sm:py-16 bg-muted/30">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-sm sm:text-base mb-6">
            Subscribe to our newsletter for the latest insights, updates, and stories from the research community.
          </p>
