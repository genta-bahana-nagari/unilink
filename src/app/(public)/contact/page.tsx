...
const FAQS = [
  {
    ...
    answer:
      "Navigate to the Events page and click 'Create Event'. Fill in the details and submit for review.",
  },
  {
    question: "How does matching work?",
    description:
      "Our algorithm analyzes participant profiles and project requirements to suggest the best matches.",
  },
  {
    question: "Is Fivo free to use?",
    answer:
      "Yes, basic access is free. We offer premium features for organizations.",
  },
  {
    question: "How do I apply for research studies?",
    answer:
      "Browse the Research page, find a study that matches your profile, and click 'Apply Now'.",
  },
];
